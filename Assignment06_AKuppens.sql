...
-- 2017-01-01,AKuppens,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_AKuppens')
	 Begin 
	  Alter Database [Assignment06DB_AKuppens] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_AKuppens;
	 End
	Create Database Assignment06DB_AKuppens;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_AKuppens;
...
As
  ...
  Order By ProductName, CategoryName, ProductName, Count
  go
...
As
 ...
 Inner Join vEmployees as M
 On E.ManagerID = M.EmployeeID
 Order By CategoryName, ProductName, InventoryID, Employees  -- Category, Product, InventoryID, and Employee.
 go

...
-- 2022-11-30,AKuppens,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_AKuppens')
	 Begin 
	  Alter Database [Assignment07DB_AKuppens] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_AKuppens;
	 End
	Create Database Assignment07DB_AKuppens;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_AKuppens;
...
[CountVsPreviousCountKPI] = IsNull(Case
 ...
 Order By ProductName, Month (InventoryDate), 3
 go
...
Return Select
   ...
   InventoryCount,
   InventoryDate,
   [PreviousMonthCount],[CountVsPreviousCountKPI]
